...
mod tests {
    ...
    fn test_network_address_ipv4() {
        let addr: NetworkAddress = "192.168.1.1".parse().expect("Failed to parse");
    ...
    fn test_network_address_ipv6() {
        let addr: NetworkAddress = "2001:db8::1".parse().expect("Failed to parse");
