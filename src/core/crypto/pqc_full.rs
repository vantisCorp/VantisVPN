...
impl MlKemKeyPair {
    ...
    pub fn generate(security_level: MlKemSecurityLevel) -> Result<Self> {
        ...
        info!("Generated ML-KEM key pair with security level {:?}", security_level);
...
impl MlDsaKeyPair {
    ...
    pub fn generate(security_level: MlDsaSecurityLevel) -> Result<Self> {
        ...
        info!("Generated ML-DSA key pair with security level {:?}", security_level);
...
impl PqcManager {
    ...
    pub fn generate_ml_kem_keypair(&self, security_level: MlKemSecurityLevel) -> Result<MlKemKeyPair> {
        MlKemKeyPair::generate(security_level)
    }
    
    /// Generate ML-DSA key pair
    pub fn generate_ml_dsa_keypair(&self, security_level: MlDsaSecurityLevel) -> Result<MlDsaKeyPair> {
        MlDsaKeyPair::generate(security_level)
    }
    
    /// Create hybrid key exchange
    pub fn create_hybrid_exchange(&self, security_level: MlKemSecurityLevel) -> Result<HybridKeyExchange> {
...
mod tests {
    ...
    fn test_hybrid_key_exchange() {
        ...
        let shared_secret = exchange.exchange(&public_key)
