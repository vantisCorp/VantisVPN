...
- [x] Add missing documentation to reduce compiler warnings (283 items documented across 25 files)
- [ ] Continue reducing warnings (target: under 500, current: ~762 warnings)
